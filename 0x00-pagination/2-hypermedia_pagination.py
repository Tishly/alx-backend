...
def get_hyper(page: int = 1, page_size: int = 10) -> dict:
    ...
    """
    assert isinstance(page, int) and page > 0, "page argument must be an integer greater than 0"
    assert isinstance(page_size, int) and page_size > 0, "page_size argument must be an integer greater than 0"
